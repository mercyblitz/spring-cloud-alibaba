...
/**
 * The Auto-Configuration class for Dubbo REST metadata registration, REST metadata that
 * is a part of {@link Registration#getMetadata() Spring Cloud service instances'
 * metadata} will be registered Spring Cloud registry.
 *
...
public class DubboRestMetadataRegistrationAutoConfiguration {
	...
	public void recordRestMetadata(ServiceBeanExportedEvent event)
		...
		serviceRestMetadata
				.addAll(metadataResolver.resolveServiceRestMetadata(serviceBean));
	}
	...
	public void registerRestMetadata(InstancePreRegisteredEvent event) throws Exception {
		...
		metadataConfigService.publishServiceRestMetadata(registration.getServiceId(),
				serviceRestMetadata);
	}
